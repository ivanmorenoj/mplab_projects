...
#define LOW_NIBBLE      //se usa el nibble bajo del puerto,undef si se usa el nibble alto
...
static const char init_str[4] = {0x28, 0xc, 0x1, 0x6};
/*
...
*   \a establecer el cursor en la posicion 1,1
*   \f limpiar y establecer el cursor en la posicion 1,1
*   \n establece el cursor en la posicion 1,2
